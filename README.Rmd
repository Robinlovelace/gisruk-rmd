...
The goal of gisruk-rmd is to provide a template for GISRUK paper submissions.

To use it:

1. Edit the example-paper.Rmd document, e.g. by downloading this repo, opening the RStudio project and entering the following:
```r
